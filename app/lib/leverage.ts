...
export const LEVERAGE_MARKETS: LeverageMarket[] = [
  ...
  {
    marketId: "4052420",
    eventSlug: "what-price-will-bitcoin-hit-in-september-2026",
    marketSlug: "will-bitcoin-reach-82pt5k-in-september-2026",
    yesTokenId:
      "53215408497553350036933045219943771968236137036851543128018382156435662039010",
    maxLeverage: 4,
    title: "Will Bitcoin reach $82,500 in September?",
  },
  {
    marketId: "4052425",
    eventSlug: "what-price-will-bitcoin-hit-in-september-2026",
    marketSlug: "will-bitcoin-dip-to-72pt5k-in-september-2026",
    yesTokenId:
      "106688365674540998489281854184913506307078735480554715822565422415637066682013",
    maxLeverage: 4,
    title: "Will Bitcoin dip to $72,500 in September?",
  },
];
 ...
 */
export const LEVERAGE_STEPS = [1, 2, 3, 4] as const;
